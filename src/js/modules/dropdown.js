...
// This code is adapted from the AngularUI - Bootstrap Project (https://github.com/angular-ui/bootstrap)
// Released under an MIT licence

angular.module('dropdown', [])
.constant('dropdownConfig', {
	// This class is added to the "dropdown" element
	openClass: 'open'
})
...
.controller('DropdownController', ['$scope', '$attrs', 'dropdownConfig', 'dropdownService', '$animate', '$log',
	function($scope, $attrs, dropdownConfig, dropdownService, $animate, $log) {
...
.directive('dropdownToggle', ["$log", function($log) {
	return {
		restrict: 'CA',
		require: '^dropdown',
		link: function(scope, element, attrs, dropdownController) {
